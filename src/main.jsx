...
function App() {
  ...
  return <>
    ...
    <main id="top">
      ...
      <section id="about"><div className="shell about about-layout"><div className="portrait"><picture><source srcSet="/tamara-martinovic.webp" type="image/webp" /><img src="/tamara-martinovic.jpg" width="1254" height="1254" loading="lazy" decoding="async" alt="Tamara Martinovic, founder of Nos Astra" /></picture></div><div className="about-copy"><h2>Made by one person.</h2><p><span className="name">I’m Tamara Martinovic, PhD,</span> founder of Nos Astra. I design, build, and support these products myself, so the person who answers your email is the person who wrote the software.</p><a className="text-link" href="https://tamara.rocks" target="_blank" rel="noreferrer">More about Tamara</a></div></div></section>
